...
public class Timer : MonoBehaviour
{
    ...
    {
        _stopTimer=false;
        _matrix=Matrix4x4.TRS(Vector3.zero, Quaternion.identity, new Vector3(Screen.width/VirtualWidth,Screen.height/VirtualHight,1.0f));
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(Camera.main.rect.x+101, 50, 120,50), ""+_minutes.ToString("00")+ ":"+ _seconds.ToString("00"), ClockStyle);
